...
// Note: TestIsJSONParseError was removed because the function is no longer needed.
// The new implementation uses multiple parse strategies (parseJudgeResponseWithRetries)
// instead of checking error types to determine retryability.
